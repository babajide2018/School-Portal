...
<head>
    ...
    <title>CTIS School Portal</title>
    <!-- Favicon icon -->
                            ...
                            <div class="card  flex-lg-column flex-md-row ">
                                <div class="card-body card-body  text-center border-bottom profile-bx">
                                    <div class="profile-image mb-4">
                                        <img src="images/avatar/parent.png" class="rounded-circle" alt="">
                                    </div>
                                    <h4 class="fs-22 text-black mb-1">{{$user->parent_name}}</h4>
                                    <p class="mb-4">Parent</p>

                                </div>
                                <div class="card-body  border-left">
                                    <div class="d-flex mb-3 align-items-center">
                                        <a class="contact-icon mr-3" href="#"><i class="fa fa-phone" aria-hidden="true"></i></a>
                                        <span class="text-black">{{$user->father_phone}}</span>
                                    </div>
                                    <div class="d-flex mb-3 align-items-center">
                                        <a class="contact-icon mr-3" href="#"><i class="fa fa-phone" aria-hidden="true"></i></a>
                                        <span class="text-black">{{$user->mother_phone}}</span>
                                    </div>
                                    <div class="d-flex mb-3 align-items-center">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-4 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="fullname" placeholder="Enter name" value="{{$user->parent_name}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xl-4 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-icon mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="father_phone" placeholder="Phone no." value="{{$user->father_phone}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xl-4 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-icon mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="mother_phone" placeholder="Phone no." value="{{$user->mother_phone}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xl-4 col-sm-6">
                                                ...
                                                <div class="col-xl-4 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="c_password" class="form-control" name="c_password" placeholder="Enter password">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-header flex-wrap border-0 pb-0">
                                            <div class="d-sm-flex d-block">
                                                ...
                                                <div style="text-align: center">
                                                    <button type="submit" class="btn btn-primary rounded mr-3 mb-2">Save Changes</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
