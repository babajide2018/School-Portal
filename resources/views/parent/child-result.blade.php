...
<!-- Mirrored from qerza.dexignzone.com/xhtml/table-bootstrap-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Dec 2022 22:38:55 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <div>
                                    Class Teacher: <br>
                                    <img src="images/{{$teacher_img}}" alt="" style="width: 100px">
                                </div>
                                <br>
                                ...
                                <table class="table table-bordered table-striped verticle-middle table-responsive-sm">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" width="20px">ASSIGNMENT</th>
                                ...
                                <form action="{{route('generatePDF')}}" method="post">
                                    @csrf
                                    <input type="hidden" value="results" value="{{$results}}">
                                    <input type="hidden" name="name" value="{{$result->name}}">
                                    <input type="hidden" name="gender" value="{{$result->gender}}">
                                    <input type="hidden" name="class" value="{{$result->class}}">
                                    <input type="hidden" name="admission_no" value="{{$result->admission_no}}">
                                    <input type="hidden" name="class_teacher" value="{{$teacher_img}}">
                                    <button type="submit" class="btn btn-primary mb-2" style="float: right">Export Report Card</button>
                                </form>
