...
<!-- Mirrored from qerza.dexignzone.com/xhtml/table-datatable-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Dec 2022 22:38:55 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Upload Results</a></li>
                </ol>
            </div>
            <!-- row -->
            <div class="row">
                            ...
                            <div class="basic-form custom_file_input">
                                <form action="{{route('result-import')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="default-select" name="subject">
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <select class="default-select" name="class">
                                    ...
                                    <button class="btn btn-primary sw-btn-next" type="submit">Upload</button>
                                </form>
                            </div>
                        </div>
                    </div>
