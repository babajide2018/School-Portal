...
<head>
    ...
    <title>CTIS - Admin Dashboard</title>
    <!-- Favicon icon -->
                                ...
                                <div class="card-body">
                                    <div class="media">
                                        <div class="media-body mr-3">
                                            <h2 class="text-success">{{$no_of_students}}</h2>
                        ...
                        <div class="col-xl-4 col-xxl-6 col-lg-4 col-sm-6">
                            <div class="card border-card">
                                <div class="card-body">
                                    <div class="media">
                                        <div class="media-body mr-3">
                                            <h2 class="text-secondary">{{$no_of_parents}}</h2>
                                            <span class="position">Parents</span>
                                        </div>
                        ...
                        <div class="col-xl-4 col-xxl-12 col-lg-4 col-md-12">
                            <div class="card border-card">
                                <div class="card-body">
                                    <div class="media">
                                        <div class="media-body mr-3">
                                            <h2 class="text-warning">{{$no_of_teachers}}</h2>
                                            <span class="position">Teachers</span>
                                        </div>
                            ...
                            <div class="card d-flex flex-xl-column flex-sm-column flex-md-row flex-column">
                                <div class="card-body text-center border-bottom profile-bx">
                                    <div class="profile-image mb-4">
                                        <img src="{{$avatar_path}}" class="rounded-circle" alt="">
                                    </div>
                                ...
                                <div class="card-body col-xl-12 col-md-6 col-sm-12 pb-0">
                                    <h4 class="fs-18 text-black mb-3">Upcoming Events</h4>
                                    <div class="media mb-4">
                                        ...
                                        <div class="media-body">
                                            <p class="fs-14 mb-1 text-black font-w500">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Asperiores atque autem blanditiis consectetur corporis deleniti dicta eius enim eum in itaque nihil obcaecati, odit quidem sequi tenetur vel velit vero? <strong></strong></p>
                                    ...
                                    <div class="media mb-4">
                                        ...
                                        <div class="media-body">
                                            <p class="fs-14 mb-1 text-black font-w500">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam consectetur<strong>3 </strong></p>
                                            <span class="fs-14">12h ago</span>
                                        </div>
                                    </div>
                                </div>
